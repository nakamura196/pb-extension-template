import{d as e,P as t,h as n,a as i,t as r,i as o,I as a,b as s,c as l,e as c,f as d,g as p,j as u,k as h,D as g,l as f,m,G as b,n as v,o as y,r as w,N as _,p as x,q as k}from"./paper-checkbox-ab1760d5.js";import{u as A,p as S,P as E,E as T,T as C}from"./pb-code-editor-515bcb09.js";import{L,h as R,c as O,_ as z,p as P}from"./pb-mixin-ad783a5d.js";import{r as I}from"./utils-e7325746.js";import"./iron-form-6ad2e26b.js";
/**
@license
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class fa extends(T(ga(C(b(v))))){static get template(){return n`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
`}static get is(){return"vaadin-button"}static get version(){return"2.4.0"}ready(){super.ready(),this.setAttribute("role","button"),this.$.button.setAttribute("role","presentation"),this._addActiveListeners(),window.ShadyDOM&&window.ShadyDOM.flush()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("active")&&this.removeAttribute("active")}_addActiveListeners(){y(this,"down",()=>!this.disabled&&this.setAttribute("active","")),y(this,"up",()=>this.removeAttribute("active")),this.addEventListener("keydown",e=>!this.disabled&&[13,32].indexOf(e.keyCode)>=0&&this.setAttribute("active","")),this.addEventListener("keyup",()=>this.removeAttribute("active")),this.addEventListener("blur",()=>this.removeAttribute("active"))}get focusElement(){return this.$.button}}customElements.define(fa.is,fa);const ma=n`<dom-module id="lumo-progress-bar" theme-for="vaadin-progress-bar">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class va extends(T(C(ba(v)))){static get template(){return n`
    <style>
      :host {
        display: block;
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class _a extends(C(v)){static get template(){return n`
    <style>
      :host {
        display: block;
      }
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class xa extends(T(C(v))){static get template(){return n`
    <style>
      :host {
        display: block;
        position: relative;
