import{h as e,f as t,F as o,D as i,C as s,E as r,t as a,p as n}from"./paper-inky-focus-behavior-b4765f0e.js";import{d,a as l}from"./paper-checkbox-a097ce7e.js";import{E as c,T as p,D as h,u as m,p as u}from"./pb-code-editor-c156f3e4.js";import{d as g,N as b,a as v,r as f,b as w,A as y,L as _,c as x,h as E,_ as $,p as S}from"./pb-mixin-ad783a5d.js";import"./utils-e7325746.js";import"./paper-icon-button-ca3015ec.js";
/**
 * @license
 ...
 */
const C=(e,t)=>{const o=e.startNode.parentNode,i=void 0===t?e.endNode:t.startNode,s=o.insertBefore(v(),i);o.insertBefore(v(),i);const r=new b(e.options);return r.insertAfterNode(s),r},k=(e,t)=>(e.setValue(t),e.commit(),e),A=(e,t,o)=>{const i=e.startNode.parentNode,s=o?o.startNode:e.endNode,r=t.endNode.nextSibling;r!==s&&f(i,t.startNode,r,s)},R=e=>{w(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},M=(e,t,o)=>{const i=new Map;for(let s=t;s<=o;s++)i.set(e[s],s);return i},I=new WeakMap,B=new WeakMap,O=g((e,t,o)=>{let i;return void 0===o?o=t:void 0!==t&&(i=t),t=>{if(!(t instanceof b))throw new Error("repeat can only be used in text bindings");const s=I.get(t)||[],r=B.get(t)||[],a=[],n=[],d=[];let l,c,p=0;for(const t of e)d[p]=i?i(t,p):p,n[p]=o(t,p),p++;let h=0,m=s.length-1,u=0,g=n.length-1;for(;h<=m&&u<=g;)if(null===s[h])h++;else if(null===s[m])m--;else if(r[h]===d[u])a[u]=k(s[h],n[u]),h++,u++;else if(r[m]===d[g])a[g]=k(s[m],n[g]),m--,g--;else if(r[h]===d[g])a[g]=k(s[h],n[g]),A(t,s[h],a[g+1]),h++,g--;else if(r[m]===d[u])a[u]=k(s[m],n[u]),A(t,s[m],s[h]),m--,u++;else if(void 0===l&&(l=M(d,u,g),c=M(r,h,m)),l.has(r[h]))if(l.has(r[m])){const e=c.get(d[u]),o=void 0!==e?s[e]:null;if(null===o){const e=C(t,s[h]);k(e,n[u]),a[u]=e}else a[u]=k(o,n[u]),A(t,o,s[h]),s[e]=null;u++}else R(s[m]),m--;else R(s[h]),h++;for(;u<=g;){const e=C(t,a[g+1]);k(e,n[u]),a[u++]=e}for(;h<=m;){const e=s[h++];null!==e&&R(e)}I.set(t,a),B.set(t,d)}}),z=new WeakMap,P=g(e=>t=>{const o=z.get(t);if(void 0===e&&t instanceof y){if(void 0!==o||!z.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==o&&t.setValue(e);z.set(t,e)}),T=e`<dom-module id="lumo-tab" theme-for="vaadin-tab">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class q extends(c(p(L(t)))){static get template(){return e`
    <slot></slot>
`}static get is(){return"vaadin-tab"}static get version(){return"3.2.0"}ready(){super.ready(),this.setAttribute("role","tab")}_onKeyup(e){const t=this.hasAttribute("active");if(super._onKeyup(e),t){const e=this.querySelector("a");e&&e.click()}}}customElements.define(q.is,q);const j=e`<dom-module id="lumo-tabs" theme-for="vaadin-tabs">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/,D=/Apple.* Version\/(9|10)/.test(navigator.userAgent);class U extends(c(N(p(r([l],t))))){static get template(){return e`
    <style>
      :host {
        display: flex;
        align-items: center;
...
`}static get is(){return"vaadin-tabs"}static get version(){return"3.2.0"}static get properties(){return{orientation:{value:"horizontal",type:String},selected:{value:0,type:Number}}}static get observers(){return["_updateOverflow(items.*, vertical)"]}ready(){super.ready(),this.addEventListener("iron-resize",()=>this._updateOverflow()),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist"),d(this,()=>{this._updateOverflow()})}_scrollForward(){this._scroll(-this.__direction*this._scrollOffset)}_scrollBack(){this._scroll(this.__direction*this._scrollOffset)}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return this._vertical||"rtl"!==this.getAttribute("dir")?-1:1}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:this.__getNormalizedScrollLeft(this._scrollerElement);let t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;t-=1;let o=e>0?"start":"";o+=e+this._scrollOffset<t?" end":"",1==this.__direction&&(o=o.replace(/start|end/gi,e=>"start"===e?"end":"start")),o?this.setAttribute("overflow",o.trim()):this.removeAttribute("overflow"),this._repaintShadowNodesHack()}_repaintShadowNodesHack(){if(D&&this.root){const e="-webkit-backface-visibility";this.root.querySelectorAll("*").forEach(t=>{t.style[e]="visible",t.style[e]=""})}}}customElements.define(U.is,U);class F extends _{static get styles(){return x`
        ...
        `}static get properties(){return{title:{type:String,reflect:!0},type:{type:String},message:{type:String,reflect:!0}}}constructor(){super(),this.title="",this.message="",this.type="message"}render(){return E`
        <paper-dialog id="modal">
            <h2 id="title">${this.title}</h2>
            <paper-dialog-scrollable id="message" class="message" tabindex="0">${m(this.message)}</paper-dialog-scrollable>
        ...
        <div class="wrapper">
            ...
            <paper-autocomplete id="combo" text="${this.name}" placeholder="${a("odd.editor.model.param-name-placeholder")}" label="Name" 
        ...
        <form>
                        ...
                        ${this._isGroupOrSequence()?E`
                            <paper-menu-button horizontal-align="right">
                                ...
                                <paper-listbox id="modelType" slot="dropdown-content" @iron-select="${this._addNested}"
                                   ...
                                   ${"modelSequence"===this.type?E`
                                            <paper-item value="model">model</paper-item>
                                        `:""}
                                   ${"modelGrp"===this.type?E`
            ...
            <iron-collapse id="details" ?opened="${this.show}" class="details">
                ...
                <paper-input id="desc" .value="${this.desc}" placeholder="${a("odd.editor.model.description-placeholder")}"
                ...
                ${this._isModel()?E`
                            ...
                            <div class="behaviourWrapper">
                                <paper-dropdown-menu label="behaviour" id="behaviourMenu" ?disabled="${this.hasCustomBehaviour}">
                                    <paper-listbox id="behaviour" slot="dropdown-content" attr-for-selected="value"
                                        ...
                                        ${this.behaviours.map(e=>E`
                                            <paper-item value="${e}">${e}</paper-item>
                                        `)}
                                    </paper-listbox>
                                </paper-dropdown-menu>
                                <span style="align-self:center;justify-self: center;"> ${a("odd.editor.model.link-with-or")} </span>
                                <paper-input id="custombehaviour" label="" @input="${this._handleCustomBehaviour}" placeHolder="${a("odd.editor.model.custom-behaviour-placeholder")}"></paper-input>
                                <span></span>
                            </div>
                        ...
                        <div class="parameters">
                            ...
                            ${O(this.parameters,e=>e.name,(e,t)=>E`
                        ...
                        <div class="renditions">
                            ...
                            ${O(this.renditions,e=>e.name,(e,t)=>E`
        ...
        `}static get properties(){return{ident:{type:String},mode:{type:String},models:{type:Array},endpoint:{type:String}}}constructor(){super(),this.ident="",this.mode="",this.models=[],this.icon="expand-more"}render(){return E`   
        <h3>
        ...
        <div id="layout">
            <div id="drawer">
                    ...
                    <h3>
                        ...
                        <span class="icons">
                            <pb-edit-xml id="editSource"><paper-icon-button icon="code" title="${a("odd.editor.odd-source")}"></paper-icon-button></pb-edit-xml>
                            <paper-icon-button @click="${this._reload}" icon="refresh" title="${a("odd.editor.reload")}"></paper-icon-button>
                            <paper-icon-button @click="${this.save}" icon="save" title="${a("odd.editor.save")} ${this.display("save")}" 
                                ?disabled="${!this.loggedIn}"></paper-icon-button>
                        </span>
                    </h3>
                    <div id="new-element" class="input-group">
                        <paper-input id="identNew" label="${a("odd.editor.add-element")}" always-float-label="always-float-label">
                            <paper-icon-button slot="suffix" @click="${this.addElementSpec}" icon="add" tabindex="-1"></paper-icon-button>
                        </paper-input>
                    </div>

                    <div id="jump-to">
                        <paper-autocomplete id="jumpTo" label="${a("odd.editor.jump-to")}" always-float-label="always-float-label"></paper-autocomplete>
                    </div>
                    
                    <h3>${a("odd.editor.specs")}</h3>
            </div>
            <div id="navlist">
                ${O(this.elementSpecs,e=>e.ident,(e,t)=>E`
                ...
                <paper-card class="metadata">
                    <pb-collapse id="meta">
                        ...
                        <div slot="collapse-content">
                            <paper-input id="title" name="title" value="${this.title}" label="${a("odd.editor.title")}"
                                         placeholder="[${a("odd.editor.title-placeholder")}]"
                                         @change="${this._inputTitle}"></paper-input>
                            <paper-input id="titleShort" name="short-title" .value="${this.titleShort}" label="${a("odd.editor.title-short")}"
                                         placeholder="[${a("odd.editor.title-short-placeholder")}]"
                                         @change="${e=>this.titleShort=e.composedPath()[0].value}"></paper-input>
                            <paper-input id="description" name="description" .value="${P(this.description)}" label="${a("odd.editor.description-label")}"
                                      placeholder="[${a("odd.editor.description-placeholder")}]"
                                      @change="${e=>this.description=e.composedPath()[0].value}"></paper-input>
                            <paper-input id="source" name="source" ?value="${this.source}" label="${a("odd.editor.source-label")}"
                                         placeholder="[${a("odd.editor.source-placeholder")}]"
                                         @change="${e=>this.source=e.composedPath()[0].value}"></paper-input>
                            <paper-checkbox id="useNamespace" @change="${this.setUseNamespace}">${a("odd.editor.use-namespace")}</paper-checkbox>
                            ...
                            <div class="extCssEdit">
                                ...
                                <pb-edit-xml id="editCSS"><paper-icon-button icon="create" title="${a("odd.editor.css-source")}"></paper-icon-button></pb-edit-xml>
                            </div>
                        </div>
                    </pb-collapse>
                </paper-card>
