import{h as e,n as t,F as o,D as i,C as s,E as r,k as a,f as n,t as d,A as l}from"./paper-checkbox-ab1760d5.js";import{E as c,T as p,D as h,u as m,p as u}from"./pb-code-editor-515bcb09.js";import{d as g,N as b,a as v,r as f,b as w,A as y,L as _,c as x,h as E,_ as $,p as S}from"./pb-mixin-ad783a5d.js";import"./utils-e7325746.js";
/**
 * @license
...
*/;class q extends(c(p(L(t)))){static get template(){return e`
    <slot></slot>
`}static get is(){return"vaadin-tab"}static get version(){return"3.2.0"}ready(){super.ready(),this.setAttribute("role","tab")}_onKeyup(e){const t=this.hasAttribute("active");if(super._onKeyup(e),t){const e=this.querySelector("a");e&&e.click()}}}customElements.define(q.is,q);const N=e`<dom-module id="lumo-tabs" theme-for="vaadin-tabs">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/,D=/Apple.* Version\/(9|10)/.test(navigator.userAgent);class U extends(c(j(p(r([n],t))))){static get template(){return e`
    <style>
      :host {
        display: flex;
        align-items: center;
...
`}static get is(){return"vaadin-tabs"}static get version(){return"3.2.0"}static get properties(){return{orientation:{value:"horizontal",type:String},selected:{value:0,type:Number}}}static get observers(){return["_updateOverflow(items.*, vertical)"]}ready(){super.ready(),this.addEventListener("iron-resize",()=>this._updateOverflow()),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist"),a(this,()=>{this._updateOverflow()})}_scrollForward(){this._scroll(-this.__direction*this._scrollOffset)}_scrollBack(){this._scroll(this.__direction*this._scrollOffset)}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return this._vertical||"rtl"!==this.getAttribute("dir")?-1:1}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:this.__getNormalizedScrollLeft(this._scrollerElement);let t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;t-=1;let o=e>0?"start":"";o+=e+this._scrollOffset<t?" end":"",1==this.__direction&&(o=o.replace(/start|end/gi,e=>"start"===e?"end":"start")),o?this.setAttribute("overflow",o.trim()):this.removeAttribute("overflow"),this._repaintShadowNodesHack()}_repaintShadowNodesHack(){if(D&&this.root){const e="-webkit-backface-visibility";this.root.querySelectorAll("*").forEach(t=>{t.style[e]="visible",t.style[e]=""})}}}customElements.define(U.is,U);class F extends _{static get styles(){return x`
        ...
        <paper-dialog id="modal">
            ...
            <div class="buttons">
                <paper-button dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isConfirm()}">${d("dialogs.close")}</paper-button>
                <paper-button id="confirm" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${d("dialogs.yes")}</paper-button>
                <paper-button id="reject" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${d("dialogs.no")}</paper-button>
            </div>
        </paper-dialog>
                ...
                <paper-card class="metadata">
                    <pb-collapse id="meta">
                        ...
                        <div slot="collapse-content">
                            ...
                            <paper-input id="description" name="description" .value="${P(this.description)}" label="${d("odd.editor.description-label")}"
